                ...
                <div class="card-body">
                    ...
                    {{-- <form method="POST" action="{{ route('event.store') }}"> --}}
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="contactNumber" type="tel" class="form-control @error('contactNumber') is-invalid @enderror" name="contactNumber" value="{{ old('contactNumber') }}"  required autocomplete="name" autofocus placeholder="01xxxxxxxx">
